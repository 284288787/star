...
public class HttpsRequest {
  ...
  private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
    ...
    // File(Configure.getCertLocalPath()));//加载本地的证书进行https加密传输
    // try {
    // keyStore.load(instream,
    // Configure.getCertPassword().toCharArray());//设置证书密码
  ...
  public String sendPost(String url, Object xmlObj) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
    ...
    try {
      ...
      Util.log("http get throw ConnectionPoolTimeoutException(wait time out)");

    } catch (ConnectTimeoutException e) {
      Util.log("http get throw ConnectTimeoutException");

    } catch (SocketTimeoutException e) {
      Util.log("http get throw SocketTimeoutException");
