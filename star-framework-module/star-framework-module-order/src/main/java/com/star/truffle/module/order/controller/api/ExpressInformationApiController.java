...
public class ExpressInformationApiController {
  ...
  @RequestMapping(value = "/queryExpressInformationCount", method = RequestMethod.POST)
  @ApiOperation(value = "根据条件获取物流信息数量", notes = "根据条件获取物流信息数量", httpMethod = "POST", response = ApiResult.class)
  @ApiImplicitParams({
    @ApiImplicitParam(name = "id", value = "主键", dataType = "Long", required = false, paramType = "query"),
    @ApiImplicitParam(name = "code", value = "编号", dataType = "String", required = false, paramType = "query"),
    @ApiImplicitParam(name = "sender", value = "寄件人", dataType = "String", required = false, paramType = "query"),
  ...
  public ApiResult<Long> queryExpressInformationCount(@ApiIgnore ExpressInformationRequestDto expressInformationRequestDto) {
    try {
  ...
  @RequestMapping(value = "/saveExpressInformation", method = RequestMethod.POST)
  @ApiOperation(value = "新增物流信息", notes = "新增物流信息", httpMethod = "POST", response = ApiResult.class)
  @ApiImplicitParams({
  })
  public ApiResult<Long> saveExpressInformation(@ApiIgnore ExpressInformation expressInformation) {
    try {
      Long id = expressInformationService.saveExpressInformation(expressInformation);
  ...
  @RequestMapping(value = "/updateExpressInformation", method = RequestMethod.POST)
  @ApiOperation(value = "编辑物流信息", notes = "编辑物流信息", httpMethod = "POST", response = ApiResult.class)
  @ApiImplicitParams({
  })
  public ApiResult<Void> updateExpressInformation(@ApiIgnore ExpressInformationRequestDto expressInformationRequestDto) {
    try {
      expressInformationService.updateExpressInformation(expressInformationRequestDto);
  ...
  @RequestMapping(value = "/deleteExpressInformation", method = RequestMethod.POST)
  @ApiOperation(value = "根据主键删除物流信息", notes = "根据主键删除物流信息", httpMethod = "POST", response = ApiResult.class)
  @ApiImplicitParams({
    @ApiImplicitParam(name = "id", value = "主键", dataType = "Long", required = true, paramType = "query")
  })
  public ApiResult<Void> deleteExpressInformation(Long id) {
    try {
      expressInformationService.deleteExpressInformation(id);
      return ApiResult.success();
    } catch (StarServiceException e) {
      return ApiResult.fail(e.getCode(), e.getMsg());
    } catch (Exception e) {
