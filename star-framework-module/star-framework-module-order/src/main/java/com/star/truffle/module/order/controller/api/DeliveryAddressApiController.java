...
public class DeliveryAddressApiController {
  ...
  @ApiImplicitParams({
    ...
    @ApiImplicitParam(name = "provinceId", value = "省", dataType = "Long", required = true, paramType = "query"),
    @ApiImplicitParam(name = "cityId", value = "市", dataType = "Long", required = true, paramType = "query"),
    @ApiImplicitParam(name = "areaId", value = "区县", dataType = "Long", required = true, paramType = "query"),
